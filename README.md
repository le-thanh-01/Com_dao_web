...
### Thêm suất cơm ngoại lệ không tính quota

```js
// CartContext.jsx
const QUOTA_EXCLUDED_BED_IDS = new Set([25, 99, 120]);
```
            ...
            <li key={link}>
              <a
                ...
                className={
                  ...
                  //Cập nhật thông tin trang mới tại đây
                ...
                onClick={(e) => {
                  ...
                  //Cập nhật điều hướng trang mới bằng onNavigate hoặc window.open()
                }}
```
